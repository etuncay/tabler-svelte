                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/007m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/009m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/010m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/005f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/006f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/008f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/009f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/010f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/011m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/012m.jpg)"></span>
                                    <div>
                                        <div>Ban Rzehor</div>
                                        <div class="text-muted">1 week and 1 day ago</div>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/011f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/012f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/013m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/013f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/015f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/016f.jpg)"></span>
                                    <div>
                                        <div>Ninon Don</div>
                                        <div class="text-muted">1 week and 1 day ago</div>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/015m.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/017f.jpg)"></span>
                                    <div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <span class="avatar me-3 rounded" style="background-image: url(/static/avatars/018f.jpg)"></span>
                                    <div>
